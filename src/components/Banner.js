...
export default function Banner() {
  window.addEventListener("scroll", () => {
    document
      ...
      .classList.toggle("invisiblee", window.scrollY > 1);
  });

  return (
    <div id="banner" className="bg-blue-400">
      <div className="max-w-7xl mx-auto  px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between flex-wrap">
          <div className="w-0 flex-1 flex items-center">
            ...
            <hr className="w-[1px] h-[20px] bg-white" />
            <span className="ml-5 flex p-1 rounded-lg ">
              <MailIcon className="h-5 w-5 text-white" aria-hidden="true" />
            </span>
            <a
              href="mailto: samablue@samablue.ma"
              target="_blank"
              rel="noreferrer"
              className="ml-2 font-medium text-white truncate cursor-pointer"
            >
          ...
          <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3 flex gap-x-3 cursor-pointer">
            <a
              href="https://www.facebook.com/samablue.ma"
              target="_blank"
              rel="noreferrer"
              className="-mr-1 flex p-2 hover:bg-blue-500  sm:-mr-2"
            >
