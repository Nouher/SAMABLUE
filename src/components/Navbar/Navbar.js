      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 dark:border-gray-500 py-6 md:justify-start md:space-x-10">
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            ...
            <a
              href="#whatsapp"
              className="bg-[#318CE7] text-[#fff] hover:bg-blue-500  ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium "
            >
              Contact US
            </a>
          </div>
